...
{	
	...
	try {
        ...
        if($data2['act']=='friend'){
            ...
            if($value[zt]==0){
                ...
                $act='<a href="javascript:void(0)" onclick="qdtj('.$friend[id].')">确定添加</a>';
            }
            if($value[zt]==1){
                $act='等待通过';
            }
            if($value[zt]==2){
                $act='<a href="javascript:void(0);" onclick="window.parent.frames.jrhy('.$value[id].')">进入</a>';
            }
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">用户账号</span>:'.$value[friend].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">真实姓名</span>:'.$value[true_name].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">手机号</span>:'.$value[mobile].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">操作</span>:'.$act.'</span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>
                    ';
            }
            ...
            $html=$html.'<tr>
            <td style="text-align: center;"><a href="javascript:void(0);" onclick="pagexx('.$last.')">上一页</a></td>
            <td style="text-align: center;"><a href="javascript:void(0);" onclick="pagexx('.$next.')">下一页</a></td>
            </tr>';
        ...
        if($data2['act']=='notice'){
            ...
            $html=$html.'<div class="message-body" data-id="35">
            <span class="message-body-head-date">'.date('Y-m-d',strtotime($value[post_date])).'</span>
            <span class="message-body-head-content"><a href="noticeinfo.html?page='.$value[id].'" rel="modalWin">'.$value[post_title].'</a></span>
            </div>';
            }
            addhtml($html,$connection);
        }
        ...
        if($data2['act']=='messages'){
            ...
            foreach ($list as $key => $value) {
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">标题</span>:'.$value[title].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">留言时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">回复时间</span>:'.$value[MA_replyTime].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">回复内容</span>:'.$value[reply].'</span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
        ...
        if($data2['act']=='bee'){
            ...
            foreach ($list as $key => $value) {
             $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">蜜蜂数量</span>:'.$value[number].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">采蜜日期</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">备注</span>:'.$value[notice].'</span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
        ...
        if($data2['act']=='growth'){
            ...
            foreach ($list as $key => $value) {
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">新增肥料</span>:'.$value[money].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">生长倍数</span>:'.$value[grouth].'</span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
        ...
        if($data2['act']=='fertilize'){
            ...
            foreach ($list as $key => $value) {
             $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">施肥重量</span>:'.$value[number].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">施肥时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">备注</span>:'.$value[notice].'</span></td>
                    </tr>
        ...
        if($data2['act']=='reap'){
            ...
            foreach ($list as $key => $value) {
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">收割数量</span>:'.$value[number].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">收割时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">备注</span>:'.$value[notice].'</span></td>
                    </tr>
    ...
    $list=$db->getAll('select * from jz_get_help where line_type=1 and user_login="'.$user[user_login].'" order by id desc limit '.$spage.','.$epage);
            ...
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">出售数量</span>:'.$value[money].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">手续费</span>:'.($value[money]*$sxf[$value[line_type]]/100).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">购买人</span>:'.$match[provide_user].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">联系方式</span>:'.$puser[mobile].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">状态</span>:'.$type[$value[status]].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">创建时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">交易时间</span>:'.date('Y-m-d',strtotime($match[create_time])).'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">操作</span>:'.$act.'</span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
        ...
        if($data2['act']=='seed'){
            ...
            foreach ($list as $key => $value) {
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">奖励道具</span>:'.$value[notice].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">奖励时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
        ...
        if($data2['act']=='seeding'){
            ...
            foreach ($list as $key => $value) {
            $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">播种数量</span>:'.$value[number].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">播种时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">备注</span>:'.$value[notice].'</span></td>
                    </tr>
    ...
    $list=$db->getAll('select * from jz_provide_help where user_login="'.$user[user_login].'" order by id desc limit '.$spage.','.$epage);
            ...
            $type=array("等待付款","等待确认","交易完成");
                        $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">购买数量</span>:'.$value[money].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">出售人姓名</span>:'.$match[get_user].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">出售人电话</span>:'.$guser[mobile].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">当前状态</span>:'.$type[$value[status]].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">创建时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">交易时间</span>:'.date('Y-m-d',strtotime($match[create_time])).'</span></td>
    ...
    $list=$db->getAll('select * from jz_get_help where status=0  and user_login!="'.$user[user_login].'" order by id desc limit '.$spage.','.$epage);
            ...
            $user=$db->getOne('select * from jz_user where user_login="'.$value[user_login].'" order by id desc ');
                        $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">卖家姓名</span>:'.$user[user_login].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">卖家手机号</span>:'.$user[mobile].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">数量</span>:'.$value[money].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">创建时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">操作</span>:<a href="javascript:void(0)" onclick="gm('.$value[id].')">购买</a></span></td>
                    </tr>
                    <tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
        ...
        if($data2['act']=='created'){
            ...
            foreach ($list as $key => $value) {
                 ...
                 $html=$html.'<tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">用户账号</span>:'.$value[user_login].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">真实姓名</span>:'.$value[true_name].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">手机号</span>:'.$value[mobile].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">性别</span>:'.$value[sex].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">支付宝</span>:'.$value[alipay].'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">微信</span>:'.$value[weixin].'</span></td>
                    </tr>
                    <tr>
                    <td data-id="0"><span class="log-line-item-left"><span style="color:#e79e11;">注册时间</span>:'.date('Y-m-d',strtotime($value[create_time])).'</span></td>
                    <td data-id="0"><span class="log-line-item-right"><span style="color:#e79e11;">操作</span>:<a href="javascript:void(0);" onclick="window.parent.frames.jrfriend('.$value[id].')">进入</a></span></td>
                    </tr><tr style="backgrount:#ffffff;height:10px;"></tr>';
            }
...
function addpage($sl,$page,$connection){
    ...
    for($i=$ks;$i<=$sl && $i<$page+3;$i++){
            $html=$html.'<li>
                <span class="active" style="tabView">'.$i.'</span>
            </li>';
    }
